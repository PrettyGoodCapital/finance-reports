...
lint-py:  ## lint python with ruff
	python -m ruff check finance_reports
	python -m ruff format --check finance_reports
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix finance_reports
	python -m ruff format finance_reports
...
test:  ## run python tests
	python -m pytest -v finance_reports/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v finance_reports/tests --cov=finance_reports --cov-report term-missing --cov-report xml
